...
WebUI.setText(findTestObject('Object Repository/Page_Guru99 Bank Delete Account Page/input_Account No_accountno'), '1245267892')

WebUI.click(findTestObject('Object Repository/Page_Guru99 Bank Delete Account Page/input_Account Number must not be blank_AccSubmit'))
